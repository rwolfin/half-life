...
Scheme
{
	...
	Colors
	{
		...
		// base colors
		"BaseText"			"219 219 219 255"	// used in text windows, lists
		"BrightBaseText"	"255 255 255 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"166 166 166 255"	// dim base text
		"LabelDimText"		"168 168 168 255"	// used for info text
		"ControlText"		"219 219 219 255"	// used in all text controls
		"BrightControlText"	"189 188 187 255"	// use for selected controls
		...
		// background colors
		"ControlBG"			"82 82 82 255"		// background color of controls
		"ControlDarkBG"		"107 107 107 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"66 66 66 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"143 143 143 255"	// background color of any selected text or menu item
		"SelectionBG2"		"43 43 43 255"		// selection background in window w/o focus
		"ListBG"			"66 66 66 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 255 255 255"
		"TitleDimText"		"145 145 144"
		"TitleBG"			"89 89 89 89"
		"TitleDimBG"		"89 89 88 0"
		...
		"BorderDark"		"43 43 43 255"		// the dark/unlit side of a control
...
//		Tooltip.BgColor				"255 155 0 255"
		...
		"MainMenu.DepressedTextColor"		"179 179 179 255"
		"MainMenu.MenuItemHeight"		"30"
		"MainMenu.Inset"		"32"
		"MainMenu.Backdrop"		"0 0 0 156"
		"Console.TextColor"			"OffWhite"
		"Console.DevTextColor"		"191 191 191 255"
		
		InGameDesktop
		{
			"MenuColor"			"200 200 200 255"
			"ArmedMenuColor"	"255 255 255 255"
			"DepressedMenuColor" "191 191 191 255"
